...
namespace PizzaOrderingApp
{
	internal class Program
	{
		static void Main(string[] args)
		{
			...
			PizzaToppingSelectionHandler toppingHandler = new PizzaToppingSelectionHandler(); // Anta at denne klassen er implementert

		
			CartMenu cartMenu = new CartMenu(shoppingCart, displayMenus, toppingHandler);

			// Vis menyen og håndter brukerinteraksjon
			cartMenu.ShowMenu();
